    ...
    var Comments = {
        ...
        saveOnKeydown: function(ev) {
            ...
            if(ev.keyCode === 13 && !(ev.metaKey || ev.ctrlKey)) {
                if(this.options.postCommentOnEnter) {
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            if(this.options.enableDeleting && this.isAllowedToDelete(commentModel.id) && commentModel.createdByCurrentUser || this.options.currentUserIsAdmin) actions.append(deleteButton);
